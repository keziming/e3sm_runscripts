...
readonly CASE_NAME="mam5.UCI.MOSAIC.v2.LR.bi-grid.amip.t0"
#readonly CASE_GROUP="v2.LR.chemUCI"

# Code and compilation
readonly CHECKOUT="E3SM_kzm_chemUCI_MOSAIC"
#readonly BRANCH="master"   #420e251265928a4122a5eb5d4eab4ae8110f84f2 05/172022  
readonly BRANCH="mingxuanwupnnl/atm/chemUCI-chemMZT-MOSAIC_AMIP"     
...
readonly RUN_REFDIR="/lcrc/group/e3sm/ac.zke/E3SM_inputs/rest/v2.LR.amip_0101/rest/1990-01-01-00000/"
readonly RUN_REFCASE="v2.LR.amip_0101"
readonly RUN_REFDATE="1990-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'
...
nhtfrq = 0, -24, -6,-6,-3,-24,0
 ...
 fincl2 = 'FLUT','PRECT','U200','V200','U850','V850','Z500','OMEGA500','UBOT','VBOT','TREFHT','TREFHTMN:M','TREFHTMX:X','QREFHT','TS\
','PS','TMQ','TUQ','TVQ','TOZ', 'FLDS', 'FLNS', 'FSDS', 'FSNS', 'SHFLX', 'LHFLX', 'TGCLDCWP', 'TGCLDIWP', 'TGCLDLWP', 'CLDTOT', 'T25\
0', 'T200', 'T150', 'T100', 'T050', 'T025', 'T010', 'T005', 'T002', 'T001', 'TTOP', 'U250', 'U150', 'U100', 'U050', 'U025', 'U010', \
'U005', 'U002', 'U001', 'UTOP', 'FSNT', 'FLNT'                                                                                       
 ...
 fincl6 = 'CLDTOT_ISCCP','MEANCLDALB_ISCCP','MEANTAU_ISCCP','MEANPTOP_ISCCP','MEANTB_ISCCP','CLDTOT_CAL','CLDTOT_CAL_LIQ','CLDTOT_CA\
L_ICE','CLDTOT_CAL_UN','CLDHGH_CAL','CLDHGH_CAL_LIQ','CLDHGH_CAL_ICE','CLDHGH_CAL_UN','CLDMED_CAL','CLDMED_CAL_LIQ','CLDMED_CAL_ICE'\
,'CLDMED_CAL_UN','CLDLOW_CAL','CLDLOW_CAL_LIQ','CLDLOW_CAL_ICE','CLDLOW_CAL_UN'                                                      
 fincl7 = 'O3', 'PS', 'TROP_P' 
...
case_setup() {
    ...
    ./xmlchange --id CAM_CONFIG_OPTS --append --val='-chem linoz_mam5_resus_mom_soag  -usr_mech_infile /home/ac.zke/E3SM_codes/mam5.chem/chem_mech_MAM5_SC.in -cosp'
    # Custom user_nl
    user_nl
