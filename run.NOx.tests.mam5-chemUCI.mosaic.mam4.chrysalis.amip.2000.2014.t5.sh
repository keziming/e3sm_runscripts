...
readonly CASE_NAME="M4.UCI.M5-UCI-MOSAIC-MZT.NOx.t5"
...
case_setup() {
    ...
    echo $CASE_ROOT_1
    local usr_mech_infile="${CODE_ROOT}/components/eam/chem_proc/inputs/pp_chemUCI_linozv3_mam4_resus_mom_soag_tag_n2o5_to_HNO3_t5.in" 
