...
readonly CASE_NAME="M5.UCI.SICE.historical.T1.0101"
#readonly CASE_GROUP="v2.LR.chemUCI"

# Code and compilation
readonly CHECKOUT="chemUCI-MOSAIC-MAM5-08072022"
...
readonly RUN_REFDIR="/lcrc/group/e3sm/ac.forsyth2/E3SMv2/v2.LR.historical_0101/init"
...
&prescribed_ghg_nl
 prescribed_ghg_cycle_yr                = 1995
 prescribed_ghg_datapath                = '/lcrc/group/e3sm/data/inputdata/atm/cam/chem/methane'
 prescribed_ghg_file            = 'ch4_oxid_1.9x2.5_L26_1990-1999clim.c090804.nc'
 prescribed_ghg_filelist                = ''
 prescribed_ghg_specifier               = 'prsd_ch4:CH4'
 prescribed_ghg_type            = 'CYCLICAL'
/
...
case_setup() {
   ...
   local source_codes="/home/ac.zke/E3SM_codes/sice/"
   cp ${source_codes}/nucleate_ice_cam.F90  ${CASE_SCRIPTS_DIR}/SourceMods/src.eam/
   cp ${source_codes}/nucleate_ice.F90  ${CASE_SCRIPTS_DIR}/SourceMods/src.eam/ 
   #cp ${source_codes}/modal_aero_wateruptake.F90  ${CASE_SCRIPTS_DIR}/SourceMods/src.eam/ 
   #cp ${source_codes}/modal_aero_calcsize.F90  ${CASE_SCRIPTS_DIR}/SourceMods/src.eam/ 
