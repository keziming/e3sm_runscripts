...
readonly CASE_NAME="20220918.adjchem.usr_h4.1yr.v2.LR.bi-grid.amip.chemUCI_Linozv3"
...
fincl5 = 'PS','H2O_vmr','T',
         ...
         'r_N2O5_aer','r_NO3_aer','r_NO2_aer','r_HO2_aer'
...
case_setup() {
    ...
    local usr_mech_infile="/home/ac.zke/E3SM_models/chemUCI-MOSAIC-MAM5-08162022/components/eam/chem_proc/inputs/pp_chemUCI_linozv3_mam4_resus_mom_soag_tag_adj_decomp_mingxuan4.in"
