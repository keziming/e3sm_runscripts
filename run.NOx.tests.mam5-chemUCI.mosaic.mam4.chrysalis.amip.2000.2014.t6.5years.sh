...
readonly CASE_NAME="M4.UCI.M5-UCI-MOSAIC-MZT.NOx.t6.5years"
...
&chem_inparm
 ...
 srf_emis_specifier             = 'C2H4      -> /lcrc/group/e3sm/data/inputdata/atm/cam/chem/trop_mozart_aero/emis/chem_gases/2degrees/emissions-cmip6_e3sm_C2H4_surface_1850-2014_1.9x2.5_c20210323.nc',
         ...
         'NO     -> /lcrc/group/e3sm/ac.zke/Analysis/ncfile_modification/emissions-cmip6_e3sm_NO_surface_1850-2014_1.9x2.5_c20220425_1pct_kzm.nc',
