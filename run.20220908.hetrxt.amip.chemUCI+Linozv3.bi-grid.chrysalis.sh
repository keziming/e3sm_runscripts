...
readonly CASE_NAME="20220906.MZThet.v2.LR.bi-grid.amip.chemUCI_Linozv3"
# If this is part of a simulation campaign, ask your group lead about using a case_group label
# readonly CASE_GROUP=""

# Code and compilation
readonly CHECKOUT="20220420"
readonly BRANCH="tangq/atm/chemUCI_amip" # a848108516f1531f28acf09d915c4db765ac1102, tangq/atm/chemUCI_amip as of 20220518
...
readonly RUN_REFDIR="/lcrc/group/e3sm/ac.qtang/E3SM_simulations/20220906.v2.LR.bi-grid.amip.chemUCI_Linozv3/archive/rest/2000-01-01-00000/"
readonly RUN_REFCASE="20220906.v2.LR.bi-grid.amip.chemUCI_Linozv3"
readonly RUN_REFDATE="2000-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'

# Set paths
readonly CODE_ROOT="/home/ac.qtang/E3SMv2/code/chem/${CHECKOUT}"
...
case_setup() {
    ...
    local usr_mech_infile="/home/ac.zke/E3SM_models/chemUCI-MOSAIC-MAM5-08162022/components/eam/chem_proc/inputs/pp_chemUCI_linozv3_mam4_resus_mom_soag_tag_n2o5_to_HNO3.in"
   ...
   #./xmlchange --id CAM_CONFIG_OPTS --append --val='-usr_mech_infile '${usr_mech_infile}
    ./xmlchange --id CAM_CONFIG_OPTS --append --val='-bc_dep_to_snow_updates -cosp -chem superfast_mam4_resus_mom_soag -rain_evap_to_coarse_aero -nlev 72 -usr_mech_infile '${usr_mech_infile}
    # Custom user_nl
    user_nl
