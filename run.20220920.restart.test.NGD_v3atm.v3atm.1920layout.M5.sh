...
readonly CASE_NAME="20220921.1920.NGD-v3atm.M5-UCI.restart.t1"
...
readonly RUN_REFDIR="/lcrc/group/e3sm/ac.zke/E3SM_simulations/M5.UCI.UCI-MOSAIC-MZT.AMIP.T13/archive/rest/1991-01-01-00000/"
readonly RUN_REFCASE="M5.UCI.UCI-MOSAIC-MZT.AMIP.T13"
readonly RUN_REFDATE="1991-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'
