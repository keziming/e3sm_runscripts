...
readonly CASE_NAME="M4.UCI.M5-UCI-MOSAIC-MZT.NOx.t5.5years"
...
readonly RUN_REFDIR="/lcrc/group/e3sm/ac.mwu/archive/20220504.v2.LR.bi-grid.amip.chemMZT.chrysalis/archive/rest/2000-01-01-00000/"
...
mfilt  = 1,1,1,1,1,1,1
 ...
 fincl1 = 'E90','N2OLNZ','NOYLNZ','H2OLNZ','CH4LNZ','MASS','AREA','TOZ','TROPC_P','TROPC_T','TROPC_Z','TROPS_P','TROPS_T','TROPS_Z','TROPT_P','TROPT_T','TROPT_Z','TROPW_P','TROPW_T','TROPW_Z','TROPH_P','TROPH_T','TROPH_Z','TROPE_P','TROPE_T','TROPE_Z',"O3","OH","HO2","H2O2","NO","NO2","NO3","N2O5","HNO3","HO2NO2","CO","CH2O","CH3O2","CH3OOH","DMS","SO2","ISOP","H2SO4","SOAG","so4_a1","pom_a1","soa_a1","bc_a1 ","dst_a1","ncl_a1","mom_a1","num_a1","so4_a2","soa_a2","ncl_a2","mom_a2","num_a2","dst_a3","ncl_a3","so4_a3","bc_a3","pom_a3","soa_a3","mom_a3","num_a3","pom_a4","bc_a4","mom_a4","num_a4","M_dens","H2O_vmr","CH4","NO_Lightning","NO_Aircraft","CO_Aircraft","CH4_vmr","prsd_ch4","C2H5OOH","CH3CHO",'LNO_COL_PROD','LNO_PROD','PAN','DV_O3','PS','PSDRY','lch4','r_lch4','M_dens','lco_h','r_lco_h','uci1','r_uci1'
  ...
  fincl2 = 'E90','N2OLNZ','NOYLNZ','H2OLNZ','CH4LNZ','MASS','AREA','TOZ','TROPC_P','TROPC_T','TROPC_Z','TROPS_P','TROPS_T','TROPS_Z','TROPT_P','TROPT_T','TROPT_Z','TROPW_P','TROPW_T','TROPW_Z','TROPH_P','TROPH_T','TROPH_Z','TROPE_P','TROPE_T','TROPE_Z',"O3","OH","HO2","H2O2","NO","NO2","NO3","N2O5","HNO3","HO2NO2","CO","CH2O","CH3O2","CH3OOH","DMS","SO2","ISOP","H2SO4","SOAG","so4_a1","pom_a1","soa_a1","bc_a1 ","dst_a1","ncl_a1","mom_a1","num_a1","so4_a2","soa_a2","ncl_a2","mom_a2","num_a2","dst_a3","ncl_a3","so4_a3","bc_a3","pom_a3","soa_a3","mom_a3","num_a3","pom_a4","bc_a4","mom_a4","num_a4","M_dens","H2O_vmr","CH4","NO_Lightning","NO_Aircraft","CO_Aircraft","CH4_vmr","prsd_ch4","C2H5OOH","CH3CHO",'LNO_COL_PROD','LNO_PROD','PAN','DV_O3','PS','PSDRY','lch4','r_lch4','M_dens','lco_h','r_lco_h','uci1','r_uci1'
...
&chem_inparm
 ...
 ext_frc_specifier              = 'NO2         -> /lcrc/group/e3sm/ac.zke/Analysis/ncfile_modification/emissions-cmip6_NO2_aircraft_vertical_1750-2015_1.9x2.5_c20170608_1pct_kzm.nc',
 ...
 fstrat_efold_list              = 'CH2O', 'CH3O2', 'CH3OOH', 'PAN', 'CO', 'C2H6', 'C3H8', 'C2H4', 'ROHO2', 'CH3COCH3',
         'C2H5O2', 'C2H5OOH', 'CH3CHO', 'CH3CO3', 'ISOP', 'ISOPO2', 'MVKMACR', 'MVKO2'
 ...
 solar_parms_file               = '/lcrc/group/e3sm/data/inputdata/atm/waccm/phot/wasolar_ave.nc'
 ...
 tracer_cnst_specifier          = 'CH4'
 tracer_cnst_type               = 'CYCLICAL'
 tuv_xsect_file         = '/lcrc/group/e3sm/data/inputdata/atm/cam/chem/trop_mozart/phot/tuv_xsect.nc'
...
case_setup() {
    ...
    echo $CASE_ROOT_1
    #local usr_mech_infile="${CODE_ROOT}/components/eam/chem_proc/inputs/pp_chemUCI_linozv3_mam4_resus_mom_soag_tag_n2o5_to_HNO3.in" 
