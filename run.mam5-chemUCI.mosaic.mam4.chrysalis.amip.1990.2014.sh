...
readonly CASE_NAME="M4.UCI.M5-UCI-MOSAIC-MZT.AMIP.T2"
...
nhtfrq = 0, -24, -6,-6,-3,-24,0
 ...
 fincl1 = 'PS', 'angstrm', 'cod', 'cdr', 'cdnc', 'cdnum', 'icnum', 'clt', 'lcc', 'lwp', 'iwp', 'icc',
         ...
         'PRECL', 'PRECT', 'TH7001000',
           'so4_a1','so4_a2','so4_a3','PS','num_a1','num_a2','num_a3','num_a4',
          'SO2','Z3','AREA','bc_a1','bc_a4','dst_a1','dst_a3','pom_a1','pom_a4','soa_a1','soa_a2','soa_a3',
          'SO2','SO2_CLXF', 'SO2_XFRC',
 'dgnd_a01', 'dgnd_a02','dgnd_a03','dgnd_a04','dgnumwet1','dgnumwet2','dgnumwet3','dgnumwet4'
 'AODMODE1','AODMODE2','AODMODE3','AODMODE4','NIMIX_IMM','NIMIX_CNT','NIMIX_DEP','NIHF', 'NIIMM','NIDEP','CCN3','extinct_sw_inp','extinct_lw_bnd7','extinct_lw_inp','CLD_CAL', 'TREFMNAV', 'TREFMXAV'
