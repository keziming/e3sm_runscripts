...
readonly CASE_NAME="20220918.adjchem.usr_het.1yr.v2.LR.bi-grid.amip.chemUCI_Linozv3"
...
case_setup() {
    ...
    local usr_mech_infile="/home/ac.zke/E3SM_models/chemUCI-MOSAIC-MAM5-08162022/components/eam/chem_proc/inputs/pp_chemUCI_linozv3_mam4_resus_mom_soag_tag_adj_decomp_usrhet.in"
